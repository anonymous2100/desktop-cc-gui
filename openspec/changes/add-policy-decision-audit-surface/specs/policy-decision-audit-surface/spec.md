...
The implementation MUST remain compatible with the heavy-test-noise and large-file governance workflows, and MUST be portable across Linux, macOS, and Windows.
